...
public class Producto {
	...
	@Id
	@SequenceGenerator(name="GENERADORMZP1", sequenceName="PRODUCTO_GEN", initialValue=1, allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="GENERADORMZP1")
	private long id;
	@Column(length = 20) 
